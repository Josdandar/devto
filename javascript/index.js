...
//     usrProfile = jsonDataUser.data.user;
...
//let text = html.getElementbyId("text")
...
const insertPost = async (posts) => {
        ...
        <li class="list-group-item user-p1" >
            ...
            <img src="${userImg}" alt="" srcset="">
                ...
                <div class="flex-grow-1 ms-3 user-story-text-p1 lh-1">
                    <span class="story-username-p1"><small>${
                      posts[0].postAuthor
                    }</small></span><br>
                    <span class="story-postdate-p1"><small>${posts[0].postCreationDate.substring(
                      0,
                      10
                    )}</small></span>
                </div>
  ...
  for (post in posts) {
    ...
    template += `
        <a href="./postDetail.html?postId=${
          posts[post]._id
        }" class="post_detail_id2">
        ...
        <div class="flex-grow-1 ms-3 user-story-text-p1 lh-1">
        <span class="story-username-p1"><small>${
          posts[post].postAuthor
        }</small></span><br>
        <span class="story-postdate-p1"><small>${posts[
          post
        ].postCreationDate.substring(0, 10)}</small></span>
        </div>
        </div>
        </li>
        <li class="list-group-item story-text-p1">
